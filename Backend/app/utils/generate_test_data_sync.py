"""
Generate test traffic data for testing reports and analytics (Synchronous version)
"""
import random
import sys
...
def generate_test_data(days: int = 7, roads: list = None):
    """
...
def clear_test_data():
    ...
    try:
        ...
        # Delete all records
        count = db.query(TrafficRecord).delete()
        db.commit()

        print(f"[OK] Cleared {count} records")
